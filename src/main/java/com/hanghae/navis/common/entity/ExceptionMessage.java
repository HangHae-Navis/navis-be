...
public enum ExceptionMessage {
    ...
    SURVEY_EXPIRED(NOT_FOUND, "투표가 종료되었습니다."),
    HOMEWORK_EXPIRED(NOT_FOUND, "마감된 과제입니다."),
    HOMEWORK_SUBMIT_CHECK_TRUE(BAD_REQUEST, "최종 제출이 완료된 과제는 취소할 수 없습니다."),
    ...
    ALREADY_SUBMITTED_SURVEY(CONFLICT, "설문을 중복 제출할 수 없습니다."),
