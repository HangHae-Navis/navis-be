...
//    private List<String> updateUrlList = new ArrayList<>();
    ...
    //생성
    public VoteRequestDto(String title, String content, String subtitle, Long important, String hashtagList, long expirationDate, List<OptionRequestDto> optionRequestDto) {
